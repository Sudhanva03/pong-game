console.log("Game is starting...");
        ...
        function updatePosition() {
            if (!gamePaused) { // Only update position if the game is not paused
                ...
                if (ballX - ballRadius < 70 && ballY > topPosition1 && ballY < topPosition1 + paddleHeight) {
                    ballSpeedX = -ballSpeedX;
                }
                if (ballX + ballRadius > canvas.width - 100 && ballY > topPosition2 && ballY < topPosition2 + paddleHeight) {
                    ballSpeedX = -ballSpeedX;
                }
